...
import { Search, ShoppingCart, User, Star, Filter, Grid, List, ChevronDown, Menu, LogOut, Heart } from "lucide-react";
        ...
        <div className="min-h-screen bg-gray-50">
                            ...
                            {isAuthenticated ? (
                                <div className="hidden sm:flex items-center gap-3">
                                    ...
                                    <Button 
                                        ...
                                        onClick={() => (window.location.href = `/${(window.location.pathname.split('/')[1] || '').trim()}/favorites`)}
                                    >
            ...
            <div className="container mx-auto px-4 py-8 pb-24 sm:pb-8">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-8 text-white">
                    ...
                    <p className="text-xl opacity-90 mb-6">Shop the latest trends and find exactly what you're looking for</p>
                            ...
                            <div className="flex items-center gap-2 sm:gap-4">
                                <div className="flex items-center gap-2 px-2 sm:px-3 py-1 bg-blue-100 rounded-full">
                                    ...
                                    <span className="text-xs sm:text-sm font-medium text-blue-800">
                                        {cart.items.reduce((sum, item) => sum + item.quantity, 0)} item{cart.items.reduce((sum, item) => sum + item.quantity, 0) !== 1 ? 's' : ''}
                                    </span>
                                </div>
