...
export default function ProductCard({ product, onImageError, imageError, viewMode }: ProductCardProps) {
                ...
                <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            {/* Unit Selection */}
                            {hasMultipleUnits && (
                                <Select value={selectedUnit} onValueChange={(value: "piece" | "pack" | "dozen") => setSelectedUnit(value)}>
                                    ...
                                    <SelectContent>
                                        ...
                                        {product.dozen_selling_price > 0 && <SelectItem value="dozen">Dozen</SelectItem>}
                                    </SelectContent>
                                </Select>
                            )}
                ...
                <div className="mb-4">
                    ...
                    {hasMultipleUnits && (
                        <Select value={selectedUnit} onValueChange={(value: "piece" | "pack" | "dozen") => setSelectedUnit(value)}>
                            ...
                            <SelectContent>
                                <SelectItem value="piece">Piece - KSh {product.piece_selling_price.toLocaleString()}</SelectItem>
                                {product.pack_selling_price > 0 && (
                                    <SelectItem value="pack">Pack - KSh {product.pack_selling_price.toLocaleString()}</SelectItem>
                                )}
                                {product.dozen_selling_price > 0 && (
                                    <SelectItem value="dozen">Dozen - KSh {product.dozen_selling_price.toLocaleString()}</SelectItem>
                                )}
                            </SelectContent>
                        </Select>
                    )}
