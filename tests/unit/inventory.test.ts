describe("Inventory Management", () => {
  ...
  describe("Stock Updates", () => {
    it("should properly reduce stock after a sale", () => {
      ...
      function updateStock(product: Product, saleItem: SaleItem): Product {
        return {
          ...product,
      ...
      expect(updatedProduct.quantity).toBe(
        initialStock - mockSaleItem.quantity,
      );
    ...
    it("should trigger low stock warning when quantity falls below min_stock", () => {
      ...
      function checkLowStock(product: Product): boolean {
  ...
  describe("Stock Adjustments", () => {
    it("should properly increase stock after a restock", () => {
      ...
      expect(restockedProduct.quantity).toBe(
        mockProduct.quantity + restockQuantity,
      );
    ...
    it("should handle stock adjustments for damaged goods", () => {
      ...
      const adjustedProduct = adjustStockForDamage(
        mockProduct,
        damagedQuantity,
      );

      // Validate stock reduction
      expect(adjustedProduct.quantity).toBe(
        mockProduct.quantity - damagedQuantity,
      );
