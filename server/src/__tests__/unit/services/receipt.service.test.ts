...
describe('ReceiptService', () => {
  ...
  describe('formatReceiptText', () => {
    ...
    it('should throw an error if sale is not found', async () => {
      ...
      await expect(ReceiptService.formatReceiptText(999)).rejects.toThrow('Sale not found');
    });
  });
  ...
  describe('sendWhatsApp', () => {
    it('should send WhatsApp message and update receipt status', async () => {
      ...
      jest.spyOn(ReceiptService, 'formatReceiptText').mockResolvedValue('Test receipt');
    ...
    it('should return false if sending fails', async () => {
      ...
      jest.spyOn(ReceiptService, 'formatReceiptText').mockRejectedValue(new Error('Test error'));
