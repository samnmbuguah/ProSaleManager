describe('Report Generation', () => {
  ...
  describe('Sales Reports', () => {
    it('should calculate total sales correctly', () => {
      ...
      function calculateTotalSales(sales) {
        return sales.reduce((total, sale) => total + Number(sale.total_amount), 0);
      }
    ...
    it('should filter sales by date range', () => {
      ...
      const filteredSales = filterSalesByDateRange(mockSales, startDate, endDate);
  ...
  describe('Inventory Reports', () => {
    it('should calculate total inventory value', () => {
      ...
      function calculateInventoryValue(products) {
        return products.reduce((total, product) => {
          return total + (Number(product.quantity) * Number(product.selling_price));
        }, 0);
      }
    ...
    it('should identify low stock products', () => {
      ...
      const lowStockProducts = findLowStockProducts(mockProducts, minStockThreshold);
